            ...
            child: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Text("Añade una nueva imagen", style: AppStyles.subtitleTextStyle(context).copyWith(fontWeight: FontWeight.w600)),
                    Text(
                    ...
                    const SizedBox(height: 20),
                    Text("Título", style: AppStyles.contentTextStyle(context).copyWith(fontWeight: FontWeight.w600)),
                    ...
                    const SizedBox(height: 20),
                    Text("Descripción", style: AppStyles.contentTextStyle(context).copyWith(fontWeight: FontWeight.w600)),
                    const SizedBox(height: 5),
                    TextCustomTextField(
